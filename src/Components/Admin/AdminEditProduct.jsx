            ...
            <Container>
                <Row>
                    <div className="main-container">
                        <h5 className="mb-3 mt-3">تعديل منتج</h5>
                        <Row className="d-flex justify-content-between">
                                        ...
                                        <div className="d-flex gap-3 justify-content-between align-items-center">
                                            ...
                                            <Form.Group as={Row} className="mb-3 w-100">
                                                <Col sm="12" className="position-relative">
                                                    ...
                                                    >
                                                        <option value="">القيمة الفرعية</option>
                            ...
                            <Col md="6" sm="12" className="text-center">
                                <div>
                                    {/* Dropzone for main product image */}
                                    <div {...getRootProps({ className: 'dropzone large-dropzone' })}>
                                        <input {...getInputProps()} />
                                        {images.length > 0 ? (
                                            <div className="position-relative">
                                                <img src={images[0].preview ? images[0].preview : `http://localhost:8000${images[0].img}`} alt="preview-0" />
                                    ...
                                    <div className="image-preview-container">
                                        {[1, 2, 3].map((imgIndex) => (
                                            <div key={imgIndex} {...getRootProps({ className: "dropzone small-dropzone" })}>
                                                ...
                                                {images[imgIndex] ? (
                                                    <div className="position-relative">
                                                        <img src={images[imgIndex].preview ? images[imgIndex].preview : `http://localhost:8000${images[imgIndex].img}`} alt={`preview-${imgIndex}`} />
